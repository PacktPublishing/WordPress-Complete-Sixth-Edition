...
// CHAPTER 8 -- the basic functions.php structure ends here --
...
// CHAPTER 8 -- custom sidebar/widget definition ends here --
...
function book_updated_messages( $messages ) {
	$messages['book'] = array(
		...
		print('Book published. <a href="%s">View book</a>', esc_url(get_permalink($post_ID))), 
		'Book saved.', 
